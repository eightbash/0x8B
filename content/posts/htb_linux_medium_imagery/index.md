...
1. **Input Sanitization**
   - Implement HTML sanitization for all user inputs
   - Use allowlists for file paths
   - Validate and escape all parameters passed to shell
...
3. **Sudo Hardening**
   ...
   - Implement argument restrictions for allowed commands
   - Use sudoedit instead of allowing shell access
...
4. **Principle of Least Privilege**
   ...
   - Separate admin functions to different applications
...
```
00:00 - Port scan and service discovery
00:10 - Web application enumeration
00:20 - XSS exploitation and admin cookie theft
00:30 - LFI to extract db.json
00:40 - Hash cracking → testuser credentials
00:50 - Command injection → reverse shell
01:00 - File system enumeration
01:10 - AES backup transfer and brute-force
01:30 - Password found → mark user access
01:40 - User flag captured
01:50 - Sudo enumeration → charcol discovery
02:00 - charcol abuse → root access
02:10 - Root flag captured
```
